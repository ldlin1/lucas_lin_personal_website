function greetingFunc() {
    ...
    if (h>=5 && h<12) {
        E.innerHTML=" Good morning, I am Lucas lin";
    } else if (h>=12 && h<18) {
        E.innerHTML+=" Good afternoon, I am Lucas Lin";
    } else if (h>=18 && h<20) {
        E.innerHTML=" Good evening, I am Lucas Lin";
    } else {
        E.innerHTML="Good night, I am Lucas Lin";
    } 
} 
